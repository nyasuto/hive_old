...
def test_document_manager() -> bool:
...
"""
        ...
        report_path = doc_manager.create_report(
            "Document Manager Test", report_content, "test", "test_session_001"
        )
...
"""
        ...
        analysis_path = doc_manager.create_analysis_document(
            "Bee Report Output Analysis", analysis_content, "test_session_001"
        )
...
def test_migration_scenario() -> bool:
