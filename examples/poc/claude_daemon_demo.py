...
async def main():
    ...
    if not DEPENDENCIES_AVAILABLE:
        ...
        print("   このデモには以下が必要です:")
        print("   - hive.agents_distributed.distributed.claude_daemon")
        ...
        print("   2. examples/poc/issue_solver_agent.py を実行")
        return
...
async def interactive_demo():
    ...
    if not DEPENDENCIES_AVAILABLE:
        print("❌ 必要な依存関係が見つかりません")
        print("   新アーキテクチャ移行により、このデモは現在利用できません")
        print("\\n💡 代替案:")
        print("   1. scripts/start-cozy-hive.sh を使用してHiveを起動")
        print("   2. examples/poc/issue_solver_agent.py --interactive を実行")
        return
